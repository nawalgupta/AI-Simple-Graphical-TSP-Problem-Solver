...
using Simple_Graphical_TSP.logic.propositional.kb;
using Simple_Graphical_TSP.logic.propositional.parsing.ast;

namespace Simple_Graphical_TSP.logic.propositional.agent
{
    /**
