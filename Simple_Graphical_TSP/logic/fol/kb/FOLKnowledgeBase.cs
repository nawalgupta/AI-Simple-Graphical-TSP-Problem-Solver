...
using System.Linq;
using System.Text;
using Simple_Graphical_TSP.logic.fol.domain;
using Simple_Graphical_TSP.logic.fol.inference;
using Simple_Graphical_TSP.logic.fol.inference.proof;
using Simple_Graphical_TSP.logic.fol.kb.data;
using Simple_Graphical_TSP.logic.fol.parsing;
using Simple_Graphical_TSP.logic.fol.parsing.ast;

namespace Simple_Graphical_TSP.logic.fol.kb
{
    /**
